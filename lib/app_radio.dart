...
/// be selected. The values are of type `T`, the type parameter of the [AppRadio]
...
///
/// Here is an example of AppRadio widgets wrapped in ListTiles, which is similar
/// to what you could get with the AppRadioListTile widget.
///
/// The currently selected character is passed into `groupValue`, which is
/// maintained by the example's `State`. In this case, the first `AppRadio`
...
/// See also:
///
///  * [AppRadioListTile], which combines this widget with a [ListTile] so that
...
class AppRadio<T> extends StatefulWidget {
  ...
  @override
  _AppRadioState<T> createState() => _AppRadioState<T>();
}
...
class _AppRadioState<T> extends State<AppRadio<T>> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return FocusableActionDetector(
      ...
      child: Builder(
        builder: (context) {
          return _AppRadioRenderObjectWidget(
            selected: selected,
...
class _AppRadioRenderObjectWidget extends LeafRenderObjectWidget {
  const _AppRadioRenderObjectWidget({
    Key key,
  ...
  @override
  _RenderAppRadio createRenderObject(BuildContext context) => _RenderAppRadio(
        value: selected,
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderAppRadio renderObject) {
    renderObject
      ..value = selected
      ..activeColor = activeColor
      ..inactiveColor = inactiveColor
...
class _RenderAppRadio extends RenderToggleable {
  _RenderAppRadio({
    bool value,
    Color activeColor,
    Color inactiveColor,
